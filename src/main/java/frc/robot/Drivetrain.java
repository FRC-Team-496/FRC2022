...
public class Drivetrain {
  ...
  private final MotorController m_frontLeftMotor = new WPI_TalonFX(1);
  private final MotorController m_frontRightMotor = new WPI_TalonFX(2);
  private final MotorController m_backLeftMotor = new WPI_TalonFX(3);
  private final MotorController m_backRightMotor = new WPI_TalonFX(4);
  ...
  /*check correct coordinate system rotate -90deg*/
  private final Translation2d m_frontLeftLocation = new Translation2d(0.285, 0.275);
  private final Translation2d m_frontRightLocation = new Translation2d(0.285, -0.275);
  private final Translation2d m_backLeftLocation = new Translation2d(-0.285, 0.275);
  private final Translation2d m_backRightLocation = new Translation2d(-0.285, -0.275);
